    ...
    : QMainWindow(parent), ui(new Ui::interfaceClass)
{
    ...
    //ui->fete->resize(m_hauteurMax* ??,m_hauteurMax);
    ...
    double kw=1;
    double kh=1;
        kw=static_cast<double>(imgFond2.width())/static_cast<double>(imgFond.width());
        kh=static_cast<double>(imgFond2.height())/static_cast<double>(imgFond.height());
    qDebug()<<"kw vaut "<<kw;
    qDebug()<<"kh vaut "<<kh;
    ...
    boutonsPolygone* btnPoly1 = new boutonsPolygone("addition");
        ...
        btnPoly1->retaille(635*kw,235*kh);
        //btnPoly1->tourne(-20);
    ...
    boutonsPolygone* btnPoly2 = new boutonsPolygone("multiplication");
        btnPoly2->deplace(630*kw,520*kh);
        btnPoly2->retaille(425*kw,450*kh);
    ...
    boutonsPolygone* btnPoly3 = new boutonsPolygone("editeur");
        btnPoly3->deplace(50*kw,680*kh);
        btnPoly3->retaille(200*kw,285*kh);
    ...
    boutonsPolygone* btnPoly5 = new boutonsPolygone("1tableM");
     ...
     boutonsPolygone* btnPoly6 = new boutonsPolygone("2complementA");
        btnPoly6->deplace(740*kw,275*kh);
        btnPoly6->retaille(450*kw,220*kh);
        btnPoly6->tourne(12);
    ...
    boutonsPolygone* btnPoly8 = new boutonsPolygone("soustraction");
        btnPoly8->deplace(520*kw,225*kh);
    ...
    boutonsPolygone* btnPoly9 = new boutonsPolygone("4tableA");
        btnPoly9->deplace(425*kw,180*kh);
    ...
    boutonsPolygone* btnPoly10 = new boutonsPolygone("5approche",100);
        btnPoly10->deplace(1315*kw,565*kh);
