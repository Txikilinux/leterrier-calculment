/** Exercice de repéchage pour les exercices du logiciel Calcul mental
...
{
public:
    ExerciceRepechage(QStringList listeErreurs, int scoreActuel, int total, QString exo, QString nomABE, QString skillABE, int valeur, QWidget *parent=0);
private:
