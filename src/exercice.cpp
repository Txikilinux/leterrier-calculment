...
//    QRect ecran(0,0,1024,600);
    ...
    *m_imgFond = imgFond2;
    ...
    this->setFixedSize(imgFond2.width()+160+bordure,imgFond2.height()+bordure);
...
void exercice::on_btnBallon_clicked()
{
    ...
    else  QMessageBox::critical(this, trUtf8("Opération inexistante"), m_operation.append(trUtf8(", ça n'existe pas comme opération...")));
